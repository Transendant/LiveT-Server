       ...
       <body style="background-color: #fafafa">
          <div style="max-width: 520px;margin: 32px auto;padding: 16px;line-height: 24px;">
            <div class="imgH">
             ...
             <div style="padding: 8px 0">
                <p>Welcome to LiveTraders! We are delighted to have you here and look forward to helping you achieve your financial goals.</p>
             </div>
             <div style="padding: 8px 0">
          ...
          <div style="max-width: 600px; margin: 32px auto; padding: 16px">
             <div style="padding: 8px 0; font-size: 0.75em; text-align: center">
                <p>Copyright © 2020-2023, LiveTraders, All rights reserved.</p>
             </div>
        ...
        user.save((err, user) => {
          if (err) {
            ...
            const emailData = {
              from: process.env.EMAIL_FROM,
              to: email,
              subject: "Welcome to LiveTraders",
              html: `<!DOCTYPE html>
              <html lang="en">
                 <head>
                    <meta charset="UTF-8" />
                    <meta http-equiv="X-UA-Compatible" content="IE=edge" />
                    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
                    <title>Welcome to LiveTraders</title>
                    <style>
                       @import url("https://fonts.googleapis.com/css2?family=Lato:ital,wght@0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,200;1,300;1,400;1,600;1,700;1,800;1,900&display=swap");html,body {font-family: "Lato";box-sizing: border-box;margin: 0;padding: 0;}.imgH {width: auto;padding: 16px 0;}p {margin: 0;font-size: 0.9em;}li {font-size: 0.8em;line-height: 1.8em;}
                    </style>
                 </head>
                 <body style="background-color: #fafafa">
                    <div style="max-width: 520px;margin: 32px auto;padding: 16px;line-height: 24px;">
                      <div class="imgH">
                       ...
                       <div style="padding: 8px 0">
                          <p>Thanks for signing up for LiveTraders!</p>
                       </div>
                       <div style="padding: 8px 0">
                          <p>We're excited to have you get started. First, you need to know LiveTraders will never ask you for your password or credentials, For more information about us, Kindly check our white paper and also subscribe to our YouTube channel for more useful videos about LiveTraders.
                            LiveTraders is your one platform, all things Crypto Mining, Staking and trading.</p>
                       </div>
            ...
            transporter.sendMail(emailData, (err, info) => {
              if (err) {
                ...
                const txnsss = {
                  general: {
                    information:
                      "Welcome to your dashboard. Choose a staking, mining, trading plan to get started",
                    warning: "",
                    show: "i",
                  },
                  staking: {
                    information:
                      "Welcome to your staking dashboard. Choose a staking plan to get started",
                    warning: "",
                    show: "i",
                  },
                  mining: {
                    information:
                      "Welcome to your mining dashboard. Choose a mining plan to get started",
                    warning: "",
                    show: "i",
                  },
                  trading: {
                    information:
                      "Welcome to your trading dashboard. Choose a trading plan to get started",
                    warning: "",
                    show: "i",
                  },
                };
                                  ...
                                  >
                                    <tbody>
                                      <tr>
                                        ...
                                        >
                                          <em
                                            >Copyright © 2020-2023, LiveTraders, All rights
                                            reserved.</em
                                          ><br />
                                          <br />
                                          <strong>Our mailing address is:</strong><br />
                                          <a
                                            href="mailto:support@livetraders.cc"
                                            target="_blank"
                                            >support@livetraders.cc</a
                                          ><br />
                                          <br />
...
exports.withdrawal = async (req, res, next) => {
  ...
  const emailData = {
    from: process.env.EMAIL_FROM,
    to: user.email,
    subject: "[LiveTraders] Withdrawal Submitted",
    html: `<!DOCTYPE html>
    <html lang="en">
       <head>
          <meta charset="UTF-8" />
...
exports.ab = (req, res) => {
  const emailData = {
    ...
    subject: "[LiveTraders] Deposit Confirmed",
    html: `<!DOCTYPE html>
      <html
        xmlns="http://www.w3.org/1999/xhtml"
        xmlns:v="urn:schemas-microsoft-com:vml"
...
exports.settings = async (req, res, next) => {
  ...
  const emailData = {
    from: process.env.EMAIL_FROM,
    to: [user.email, "support@livetraders.cc"],
    subject: "[LiveTraders] Request for Account Modification",
    html: `<!DOCTYPE html>
    <html lang="en">
       <head>
          <meta charset="UTF-8" />
